...
bioP_df = pd.read_csv('../datasets/trainingDatasets/training_data.csv', index_col=0)
physico_chemical_df = pd.read_csv('../datasets/trainingDatasets/final_physico_chemical_result.csv')
combined_csv_df = pd.read_csv('../datasets/trainingDatasets/combined_csv.csv')
dipeptide_training_df = pd.read_csv('../datasets/trainingDatasets/dipeptide_training.csv')
final_amphiphilic_pseudo_result_df = pd.read_csv('../datasets/trainingDatasets/final_amphiphilic_pseudo_result.csv')
final_pseudo_result_df = pd.read_csv('../datasets/trainingDatasets/final_pseudo_result.csv')
final_quasi_result_df = pd.read_csv('../datasets/trainingDatasets/final_quasi_result.csv')



pybiomed_df_drop = pybiomed_df.drop(columns=['Label', 'Sequence'])
...
concat_dataset.to_csv('../datasets/trainingDatasets/concat_dataset.csv', index=False)
